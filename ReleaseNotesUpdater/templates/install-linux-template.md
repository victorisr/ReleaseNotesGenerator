...
<!-- The statement here is different in 8.0 and 9.0
...
- Detects the distribution and version. The script supports platforms and versions listed in [.NET {ID-VERSION}.0 - Supported OS versions](supported-os.md).
...
SECTION-USINGSNAP
<!-- This is only mentioned for Version 8.0 > 
## Install using Snap
...
`sudo snap install dotnet-sdk --channel={ID-VERSION}.0 --classic`
